...
namespace SGA.Controllers
{
    public class FacturadosController : Controller
    {
        ...
        {
            return View(db.facturados.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "id")] Facturado facturado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id")] Facturado facturado)
        {
            if (ModelState.IsValid)
            {
