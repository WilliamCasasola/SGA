...
namespace SGA.Controllers
{
    public class TitulosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "codigo,precio,nombre,rutaFoto")] Titulo titulo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "codigo,precio,nombre,rutaFoto")] Titulo titulo)
        {
            if (ModelState.IsValid)
            {
